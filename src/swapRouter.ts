...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@phuphamdeltalabs/sdkcore'
import { abi } from '@uniswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@phuphamdeltalabs/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
